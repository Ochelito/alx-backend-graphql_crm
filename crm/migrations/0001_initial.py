# Generated by Django 5.2.5 on 2025-11-22 16:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, max_length=20, validators=[django.core.validators.RegexValidator(message='Phone number must be valid format (+1234567890 or 123-456-7890)', regex='^(\\+\\d{1,3})?[\\d\\s-]{7,15}$')])),
            ],
        ),
        migrations.CreateModel(
            name='Product',
